...
async function main() {
  ...
  const SCOPE_SEED_STRING = "self-verified-multisend";
  const SCOPE_SEED = ethers.keccak256(ethers.toUtf8Bytes(SCOPE_SEED_STRING));
  const CONFIG_ID =
  ...
  console.log("Scope Seed String:", SCOPE_SEED_STRING);
  console.log("Scope Seed Hash:", SCOPE_SEED);
